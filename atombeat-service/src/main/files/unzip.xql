...
import module namespace unzip-protocol = "http://purl.org/atombeat/xquery/unzip-protocol" at "lib/unzip-protocol.xqm" ;
...
return util:catch( '*' , unzip-protocol:main() , local:error() )
