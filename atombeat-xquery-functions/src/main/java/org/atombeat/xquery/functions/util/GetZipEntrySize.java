...
/**
 */
public class GetZipEntrySize extends BasicFunction {

	protected static final Log log = LogFactory.getLog(GetZipEntrySize.class);
	...
	public final static FunctionSignature signature =
		new FunctionSignature(
			...
			new FunctionReturnSequenceType(Type.INTEGER, Cardinality.ZERO_OR_ONE, "uncompressed size of zip entry if present"));
		
	public GetZipEntrySize(XQueryContext context) {
