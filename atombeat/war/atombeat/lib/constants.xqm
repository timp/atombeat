...
declare variable $CONSTANT:OP-RETRIEVE-WORKSPACE-ACL as xs:string     := "RETRIEVE_WORKSPACE_ACL" ;
declare variable $CONSTANT:OP-UPDATE-WORKSPACE-ACL as xs:string       := "UPDATE_WORKSPACE_ACL" ;
declare variable $CONSTANT:OP-RETRIEVE-COLLECTION-ACL as xs:string    := "RETRIEVE_COLLECTION_ACL" ;
declare variable $CONSTANT:OP-UPDATE-COLLECTION-ACL as xs:string      := "UPDATE_COLLECTION_ACL" ;
declare variable $CONSTANT:OP-RETRIEVE-MEMBER-ACL as xs:string        := "RETRIEVE_MEMBER_ACL" ;
declare variable $CONSTANT:OP-UPDATE-MEMBER-ACL as xs:string          := "UPDATE_MEMBER_ACL" ;
declare variable $CONSTANT:OP-RETRIEVE-MEDIA-ACL as xs:string         := "RETRIEVE_MEDIA_ACL" ;
declare variable $CONSTANT:OP-UPDATE-MEDIA-ACL as xs:string           := "UPDATE_MEDIA_ACL" ;
