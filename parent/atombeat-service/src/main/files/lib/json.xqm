(:~
 :    N.B., this is a customised version of the standard eXist JSON module. See
 :    below for the standard module documentation. The following customisations
 :    have been made:
 :   
 :    <ul>
 :      <li>
 :        remove outputting of namespace prefix, as can cause inconsistent
 :        JSON output depending on how namespace prefixes have been used.
 :      </li>
 :    </ul>
 : 
 ...
 :)
module namespace json="http://atombeat.org/xquery/json";
