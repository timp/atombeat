...
ORBEON_HOME=/home/aliman/Desktop/orbeon-work/orbeon-src-20100324
VERSION=1_4_0
...
cp lib/core/antlr-2.7.7.jar $ORBEON_HOME/lib/exist-antlr-2_7_7.jar
cp lib/core/jgroups-all-2.2.6.jar $ORBEON_HOME/lib/exist-jgroups-all-exist.jar
cp lib/core/xmldb.jar $ORBEON_HOME/lib/exist-xmldb.jar
cp lib/core/xmlrpc-client-3.1.2.jar $ORBEON_HOME/lib/exist-xmlrpc-client-3_1_2.jar
cp lib/core/xmlrpc-common-3.1.2.jar $ORBEON_HOME/lib/exist-xmlrpc-common-3_1_2.jar
cp lib/core/xmlrpc-server-3.1.2.jar $ORBEON_HOME/lib/exist-xmlrpc-server-3_1_2.jar
cp lib/core/quartz-1.6.5.jar $ORBEON_HOME/lib/exist-quartz-1_6_5.jar 
cp lib/core/jta-1.1.jar $ORBEON_HOME/lib/exist-jta.jar
