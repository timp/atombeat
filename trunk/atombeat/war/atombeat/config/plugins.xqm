...
import module namespace html-plugin = "http://purl.org/atombeat/xquery/html-plugin" at "../plugins/html-plugin.xqm" ;
...
declare function plugin:before() as function* {
	(
		...
		(: 
		,
    util:function( QName( "http://purl.org/atombeat/xquery/html-plugin" , "html-plugin:before" ) , 4 )
    :)
	)
};
...
declare function plugin:after() as function* {
	(
		...
		,
    util:function( QName( "http://purl.org/atombeat/xquery/html-plugin" , "html-plugin:after" ) , 3 )
	)
};
